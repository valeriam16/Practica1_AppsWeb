            ...
            <div class="col-lg-8 col-xl-6">
                <div class="card rounded-3">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form class="px-md-2" action="{{ url('/registrar') }}" method="post">
                            @csrf
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-md">Registrar</button>
                            </div>
                        </form>
