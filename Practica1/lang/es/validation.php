...
return [
    ...
    | la clase validadora. Algunas de estas reglas tienen versiones múltiples,
    ...
    */
    ...
    | especificar un mensaje personalizado específico para una regla de atributo dada.
    |
    */
    ...
    | con algo más fácil de entender, como "Dirección de correo electrónico" en lugar de "email".
